...
$punct = [\[ \] \( \) \{ \} \_ \# \& \^ \! \* \+ \= \' \` \| \~ \. \; \? \! \: \, \" \/ \\ \-]
@nonbt = [^`]|[\n]
@backtickspan = ( `{1} @nonbt (@nonbt+ | `{2,} @nonbt+)* `{1} |
                  `{2} @nonbt (@nonbt+ | `{3,} @nonbt+ | `{1}   @nonbt+)* `{2} |
                  `{3} @nonbt (@nonbt+ | `{4,} @nonbt+ | `{1,2} @nonbt+)* `{3} |
                  `{4} @nonbt (@nonbt+ | `{5,} @nonbt+ | `{1,3} @nonbt+)* `{4} |
                  `{5} @nonbt (@nonbt+ | `{6,} @nonbt+ | `{1,4} @nonbt+)* `{5} |
                  `{6} @nonbt (@nonbt+ | `{7,} @nonbt+ | `{1,5} @nonbt+)* `{6} )
